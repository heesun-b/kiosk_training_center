      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text("키오스크 트레이닝 센터",
             style: TextStyle(fontSize: size.width * 0.04, fontFamily: MyTextStyle.ownglyphJooreeletter, fontWeight: FontWeight.bold, fontStyle: FontStyle.italic)),
            Text("KIOSK TRAINING CENTER",
